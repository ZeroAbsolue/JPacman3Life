...
public class Board {
     ...
     */
    private final Square[][] gridOfSquares;
    ...
    public Square squareAt(int x, int y) {
        ...
        Square result = gridOfSquares[x][y];
