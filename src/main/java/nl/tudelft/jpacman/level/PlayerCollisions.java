 ...
 * <p>
 * It uses a number of instanceof checks to implement the multiple dispatch for
 * the
 * collisionmap. For more realistic collision maps, this approach will not
 * scale,
...
public class PlayerCollisions implements CollisionMap {
    ...
    public void playerVersusGhost(Player player, Ghost ghost) {
        ...
        player.decrementRemainLifeNumber();
        player.setDied(true);
        if (player.getRemainLifeNumber() == 0) {
